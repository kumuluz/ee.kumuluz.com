...
export const articles = {
    section0: {
        ...
        articles: [
            ...
            new Article("Java EE 8 Microservices", "Build the foundation of Cloud Native applications with microservices using Java EE 8.", "https://dzone.com/articles/java-ee-microservices-on-kubernetes-with-kumuluzee"),
            new Article("Eclipse Microservices and Service Discovery", "Discover service discovery, an essential part of microservice architecture becomes necessary when we start using containers and container orchestration mechanisms.", "https://dzone.com/articles/java-ee-microservices-on-kubernetes-with-kumuluzee"),
