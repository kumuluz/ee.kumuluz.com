...
export const documentationItems = {
    ...
    microprofile: [
        ...
        new Sample("MicroProfile Metrics 2.0", "For collection and reporting of performance metrics.", "https://github.com/kumuluz/kumuluzee-metrics/blob/master/README.md"),
