...
export const documentationItems = {
    ...
    microprofile: [
        ...
        new Sample("MicroProfile REST Client 1.0.1", "For easy way to define and invoke RESTful services over HTTP.", "https://github.com/kumuluz/kumuluzee-rest-client/blob/master/README.md")
    ]
};
