...
export const microprofilesList = [
    ...
    // MP 1.3 Java 7
    new CheckboxModel("mp-1.3-a", [
        new VersionedLabel("2.6.0", "2.6.0", "MicroProfile 1.3 (Java EE 7)", "com.kumuluz.ee:kumuluzee-microProfile-1.3")
    ], ["comp-cdi", "comp-jsonp", "comp-jaxrs", "comp-servlet", "mpa-config", "mpa-faulttolerance", "ext-other-faulttolerance",
        "mpa-jwt-auth", "mpa-metrics", "ext-metrics", "mpa-healthcheck", "ext-other-health",
        "mpa-openapi", "mpa-opentracing", "ext-opentracing-jaeger", "mpa-rest-client"
    ]),
    // MP 1.3 Java 8+
    new CheckboxModel("mp-1.3-b", [
    ...
    // MP 1.4 Java 7
    new CheckboxModel("mp-1.4-a", [
        new VersionedLabel("2.6.0", "2.6.0", "MicroProfile 1.4 (Java EE 7)", "com.kumuluz.ee:kumuluzee-microProfile-1.4")
    ], ["comp-cdi", "comp-jsonp", "comp-jaxrs", "comp-servlet", "mpa-config", "mpa-faulttolerance", "ext-other-faulttolerance",
        "mpa-jwt-auth", "mpa-metrics", "ext-metrics", "mpa-healthcheck", "ext-other-health",
        "mpa-openapi", "mpa-opentracing", "ext-opentracing-jaeger", "mpa-rest-client"
    ]),
    // MP 1.4 Java 8+
    new CheckboxModel("mp-1.4-b", [
