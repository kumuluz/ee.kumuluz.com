...
export const microprofileAPIsList = [
    new CheckboxModel("mpa-config", [
        new VersionedLabel("2.5.2", "MicroProfile Config 1.2", "com.kumuluz.ee.config:kumuluzee-config-mp:${kumuluzee-config-mp.version}:1.3.0")
    ], []),
    ...
    new CheckboxModel("mpa-openapi", [
        new VersionedLabel("2.5.3", "MicroProfile OpenApi 1.0", "com.kumuluz.ee.openapi:kumuluzee-openapi:${kumuluzee.openapi.version}:1.0.1")
    ], []),
    new CheckboxModel("mpa-opentracing", [
        new VersionedLabel("2.5.3", "MicroProfile OpenTracing 1.2", "com.kumuluz.ee.opentracing:kumuluzee-opentracing-core:${kumuluzee.opentracing.version}:1.2.1")
    ], [])
];
