                    ...
                    <div className="page-content-section">
                        ...
                        <div className="content">
                            ...
                            <p>
                                ...
                                related to development and particularly to the deployment. To deploy microservices on
                            ...
                            <p>
                                ...
                                configuration of Java EE applications following the microservice pattern and makes it
                                seamless. We will showcase how you can use KumuluzEE to create microservices using
                                standard Java EE APIs that run in every Java environment as any other Java application
                            ...
                            <p>
                                ...
                                In fact if you use the default configuration (which is perfectly fine for most cases)
                            ...
                            <p>
                                The result are small standalone (and preferably stateless) microservices that can run
                                anywhere (remember “Write once, run anywhere”) using technologies that used to require
                            ...
                            <p>
                                ...
                                microservice down, as well as allow each and every microservice you create to have its
                            ...
                            <p>
                                ...
                                functionalities, of course, for brevity we are only going to look at the two of them;
                                browsing available books and placing orders. Our goal will be to create an application
                                with the following requirements:
                            </p>
                            {this.renderCheckBoxes(buildingMicroservicesCheckboxes)}
                            <p>
                                With traditional application servers we would normally create a monolithic EAR package
                                that would include our business logic and several WAR packages. Our architecture would
                                look something like this:
                            </p>
                            <div className="image-section">
                                <img
                                    src="https://d33wubrfki0l68.cloudfront.net/1c8302327ca43d7f0edb80c3517c8b93ff2d9251/1446f/assets/images/posts/microservices-with-java-ee-and-kumuluzee-updated/monolithic.png"/>
                            </div>
                            <p>
                            ...
                            <p>
                                ...
                                more traffic, we need to start scaling out. We can start to scale up, however that can
                            ...
                            <div className="image-section" style={{marginBottom: "20px"}}>
                                <img
                                    src="https://d33wubrfki0l68.cloudfront.net/d3b00da4c82ae95f375fdc512ea766a91460d508/36fcb/assets/images/posts/microservices-with-java-ee-and-kumuluzee-updated/microservice.png"/>
                            </div>
                            <p>
                                We start by separating our concerns and split the catalogue and orders functionalities
                            ...
                            <p>
                                ...
                                environment. For instance; PostgreSQL as a database, RabbitMQ as a messaging service,
...
`}
                            ...
                            <p>
                                ...
                                to use it with every dependency or import the KumuluzEE BOM module, which will include
                                the correct module dependency definitions in your project. In this sample we will use
                                the latter.
                            </p>
                            <p>
                                NOTE: Use the same version for every module as not doing so might result in unexpected
                                behavior.
                            </p>
                            <p>
                                We will import the BOM to our parent <span className="inline-code">pom.xml</span>,
                                which includes all of KumuluzEE’ dependency definitions. This will allow us to include
...
`}
                            ...
                            <p>
                                First we must include the <span className="inline-code">core</span> module to our first
                                microservice <span className="inline-code">catalogue</span>. The core includes the main
    ...
    <artifactId>kumuluzee-core</artifactId>
                            ...
                            <p>
                                ...
                                folder has to be inside the <span className="inline-code">resource</span> folder, not
                                alongside it.
                            </p>
                            <p>
...
<body>
    <p>Here we could display the book catalogue</p>
                            ...
                            <p>
                                ...
                                enter the above class as the <span className="inline-code">Main class</span> attribute.
        ...
        <execution>
            ...
            <configuration>
                <includeScope>runtime</includeScope>
                            ...
                            <p>
                                We’ll continue and add the remaining required dependencies. We will need JAX-RS for the
...
<dependency>
    ...
    <artifactId>kumuluzee-cdi-weld</artifactId>
                            ...
                            <p>
                                If you don’t want to individually select the components in advance or don’t need/want
                                to fully customize your microservice, KumuluzEE also comes with a number of predefined
                            ...
                            <h3>JPA module</h3>
                            <p>
                                In the JPA module we will add our <span className="inline-code">persistence.xml</span>
                                and entity classes that will be shared with both our microservices even though they
                                will be ran separately. In the example we will use a PostgreSQL database. However, you
                                are free to use any database JPA and Java supports. Just add the driver as a dependency.
                            </p>
                            <div className="code-block">
                                <CodeFormatComponent pages={[{filename: "/models/pom.xml", id: "models-eclipse-link"}]}>
        ...
        <properties>
            ...
            <property name="javax.persistence.schema-generation.drop-source" value="metadata"/>
                            ...
                            <p>
                                ...
                                config extension, as this particular part is not handled by any Java EE specification.
                                In short, everything in KumuluzEE (including your own settings) is configured through
                                the main <span className="inline-code">config.yaml</span> file located at the root of
...
public class Order {
    ...
    public void setBook(Book book) {
        this.book = book;
                            ...
                            <h3>Orders module</h3>
                            <p>
                                Now let’s implement the orders module. We’ll create an order resource that will contain
                            ...
                            <p>
                                NOTE: Don’t forget to add the <span className="inline-code">webapp</span> folder to the
...
public class OrdersApplication extends javax.ws.rs.core.Application {
                            ...
                            <div className="code-block">
                                <CodeFormatComponent pages={[{filename: "OrderProperties.java", id: "orders-props"}]}>
    ...
    public Response placeOrder(Book b) {
        ...
        return Response.status(Response.Status.CREATED).entity(o).build();
                            ...
                            <p>
                                ...
                                directly in code. This way we successfully decoupled our microservices from one another.
                            </p>
                            <p className="indented">
                                A microservice can and should contain multiple REST resources. To put it differently;
...
<beans xmlns="http://xmlns.jcp.org/xml/ns/javaee" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
       ...
       bean-discovery-mode="annotated">
                            ...
                            <div className="code-block">
                                <CodeFormatComponent pages={[{filename: "/catalogue/pom.xml", id: "catalog-pom-xml"}]}>
...
public class BooksResource {
    ...
    public Response createBook(Book b) {
        ...
        return Response.status(Response.Status.CREATED).entity(b).build();
                            ...
                            <p>
                                Again make sure you have added the same <span className="inline-code">beans.xml</span>
                                file as before to your <span className="inline-code">META-INF</span> directory in order
                                to enable injection.
                            </p>
                            <h2>Putting it all together</h2>
                            <p>
                                And we’re done. We have just created two microservices that will run independently of
                                each other. However they can still work together with the help of REST interfaces and
...
`}
                            ...
                            <p>
                                ...
                                and the microservice architecture and focus solely on developing with what we already
                                know but in a completely new way. KumuluzEE seamlessly sets everything up automatically
                                ...
                                are simply not possible now. It also provides all the other benefits of microservices,
                            ...
                            <p>
                                ...
                                Microservice architecture, or more generally, cloud-native architecture opens several
                                ...
                                or YAML files. KumuluzEE extensions provide even broader functionalities, not only for
